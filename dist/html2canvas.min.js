  ...
  })(
    {
        ...
        function (b, c, d) {
          (function (b) {
            !(function (e) {
              ...
              function m(a, b, c) {
                var d = 0;
                for (a = c ? K(a / B) : a >> 1, a += K(a / b); a > (J * z) >> 1; d += x)
                  a = K(a / J);
              ...
              function n(a) {
                var b,
                  ...
                  s = D,
                  t = C;
                for (c = a.lastIndexOf(E), c < 0 && (c = 0), d = 0; d < c; ++d)
              ...
              function o(a) {
                var b,
                  ...
                  t,
                  u = [];
                for (a = i(a), q = a.length, b = D, c = 0, g = C, h = 0; h < q; ++h)
              ...
              if (
                ...
                else for (v in u) u.hasOwnProperty(v) && (r[v] = u[v]);
              else e.punycode = u;
            })(this);
          }).call(
            this,
      ...
      2: [
        function (a, b, c) {
          function d(a, b, c) {
            !a.defaultView ||
              (b === a.defaultView.pageXOffset && c === a.defaultView.pageYOffset) ||
              a.defaultView.scrollTo(b, c);
          }
          function e(a, b) {
            try {
              b &&
                ...
                b
                  .getContext('2d')
                  .putImageData(a.getContext('2d').getImageData(0, 0, a.width, a.height), 0, 0));
            } catch (c) {
          ...
          function f(a, b) {
            for (
              var c = 3 === a.nodeType ? document.createTextNode(a.nodeValue) : a.cloneNode(!1),
                d = a.firstChild;
              d;

            )
              (b !== !0 && 1 === d.nodeType && 'SCRIPT' === d.nodeName) || c.appendChild(f(d, b)),
                (d = d.nextSibling);
            return (
              1 === a.nodeType &&
                ((c._scrollTop = a.scrollTop),
                (c._scrollLeft = a.scrollLeft),
                'CANVAS' === a.nodeName
                  ? e(a, c)
                  : ('TEXTAREA' !== a.nodeName && 'SELECT' !== a.nodeName) || (c.value = a.value)),
              c
            );
          }
          function g(a) {
                  ...
                  function () {
                    var a = setInterval(function () {
                      c.body.childNodes.length > 0 &&
                        ...
                        clearInterval(a),
                        'view' === h.type &&
                          (l.contentWindow.scrollTo(i, j),
                          !/(iPad|iPhone|iPod)/g.test(navigator.userAgent) ||
                            (l.contentWindow.scrollY === j && l.contentWindow.scrollX === i) ||
                            ((c.documentElement.style.top = -j + 'px'),
      ...
      3: [
        function (a, b, c) {
          ...
          d.prototype.hex3 = function (a) {
            ...
            return (
              null !== (b = a.match(e)) &&
                ((this.r = parseInt(b[1][0] + b[1][0], 16)),
          ...
          d.prototype.hex6 = function (a) {
            ...
            return (
              null !== (b = a.match(f)) &&
                ((this.r = parseInt(b[1].substring(0, 2), 16)),
          ...
          d.prototype.rgb = function (a) {
            ...
            return (
              null !== (b = a.match(g)) &&
                ((this.r = Number(b[1])), (this.g = Number(b[2])), (this.b = Number(b[3]))),
              null !== b
            );
          };
      ...
      4: [
        function (b, c, d) {
          function e(a, b) {
            ...
            if (
              ((b = b || {}),
              b.logging && ((p.options.logging = !0), (p.options.start = Date.now())),
              (b.async = 'undefined' == typeof b.async || b.async),
              (b.allowTaint = 'undefined' != typeof b.allowTaint && b.allowTaint),
              (b.removeContainer = 'undefined' == typeof b.removeContainer || b.removeContainer),
              (b.javascriptEnabled =
                'undefined' != typeof b.javascriptEnabled && b.javascriptEnabled),
              (b.imageTimeout = 'undefined' == typeof b.imageTimeout ? 1e4 : b.imageTimeout),
              (b.renderer = 'function' == typeof b.renderer ? b.renderer : l),
              (b.strict = !!b.strict),
              'string' == typeof a)
            ) {
            ...
            return (
              h.setAttribute(u + c, c),
              f(
                h.ownerDocument,
                b,
                h.ownerDocument.defaultView.innerWidth,
                h.ownerDocument.defaultView.innerHeight,
                c
              ).then(function (a) {
                return (
                  'function' == typeof b.onrendered &&
                    (p(
          ...
          function f(a, b, c, d, e) {
            return r(a, a, c, d, b, a.defaultView.pageXOffset, a.defaultView.pageYOffset).then(
              function (f) {
                p('Document cloned');
                var h = u + e,
                  i = '[' + h + "='" + e + "']";
                ...
                var j = f.contentWindow,
                  ...
                  l =
                    'function' == typeof b.onclone
                      ? Promise.resolve(b.onclone(j.document))
                      : Promise.resolve(!0);
          ...
          function i(a, b) {
            ...
            var h = e - d,
              i = g - f;
            return (
              p('Cropping canvas at:', 'left:', b.left, 'top:', b.top, 'width:', h, 'height:', i),
              p(
      ...
      7: [
        function (a, b, c) {
          ...
          (d.prototype.getMetrics = function (a, b) {
            return (
              void 0 === this.data[a + '-' + b] && (this.data[a + '-' + b] = new e(a, b)),
              this.data[a + '-' + b]
            );
          }),
            (b.exports = d);
            ...
            this.promise = (
              c
                ? new Promise(function (a) {
                    'about:blank' === b.contentWindow.document.URL ||
                    null == b.contentWindow.document.documentElement
                      ? (b.contentWindow.onload = b.onload =
                          function () {
                            a(b);
                          })
                      : a(b);
                  })
                : this.proxyLoad(d.proxy, g, d)
            )
              .then(function (b) {
                var c = a('./core');
        ...
        function (a, b, c) {
          ...
          (d.prototype.findImages = function (a) {
            ...
            (d.prototype.findBackgroundImage = function (a, b) {
              return (
                b
                  ...
                  .forEach(this.addImage(a, this.loadImage), this),
                a
              );
            }),
            (d.prototype.addImage = function (a, b) {
              return function (c) {
                c.args.forEach(function (d) {
                  this.imageExists(a, d) ||
                    (a.splice(0, 0, b.call(this, c)),
                    e('Added image #' + a.length, 'string' == typeof d ? d.substring(0, 100) : d));
                }, this);
              };
            }),
            ...
            (d.prototype.loadImage = function (a) {
              if ('url' === a.method) {
                var b = a.args[0];
                return !this.isSVG(b) || this.support.svg || this.options.allowTaint
                  ? b.match(/data:image\/.*;base64,/i)
                    ? new f(b.replace(/url\(['"]{0,}|['"]{0,}\)$/gi, ''), !1)
                    : this.isSameOrigin(b) || this.options.allowTaint === !0 || this.isSVG(b)
                    ? new f(b, !1)
                    : this.support.cors && !this.options.allowTaint && this.options.useCORS
                    ? new f(b, !0)
                    : this.options.proxy
                    ? new h(b, this.options.proxy)
                    : new g(b)
                  : new j(b);
              }
              return 'linear-gradient' === a.method
                ? new l(a)
                : 'gradient' === a.method
                ? new m(a)
                : 'svg' === a.method
                ? new k(a.args[0], this.support.svg)
                : 'IFRAME' === a.method
                ? new i(a.args[0], this.isSameOrigin(a.args[0].src), this.options)
                : new g(a);
            }),
            ...
            (d.prototype.fetch = function (a) {
              return (
                (this.images = a.reduce(n(this.findBackgroundImage, this), this.findImages(a))),
            ...
            b
                  ...
                  .forEach(function (a, b) {
                    switch (a) {
                      ...
                      case 'center':
                        break;
                      default:
                        var e = 0.01 * parseFloat(a, 10);
                        if (isNaN(e)) break;
                        0 === b
                          ? ((this.y0 = e), (this.y1 = 1 - this.y0))
                          : ((this.x0 = e), (this.x1 = 1 - this.x0));
                    }
                  }, this)
              : ((this.y0 = 0), (this.y1 = 1)),
              (this.colorStops = a.args.slice(b ? 1 : 0).map(function (a) {
                var b = a.match(e.REGEXP_COLORSTOP),
                  c = +b[2],
                  d = 0 === c ? '%' : b[3];
                return { color: new f(b[1]), stop: '%' === d ? c / 100 : null };
              })),
              ...
              this.colorStops.forEach(function (a, b) {
                null === a.stop &&
                  this.colorStops.slice(b).some(function (c, d) {
                    return (
                      null !== c.stop &&
                      ((a.stop =
                        (c.stop - this.colorStops[b - 1].stop) / (d + 1) +
                        this.colorStops[b - 1].stop),
                      !0)
                    );
                  }, this);
              }, this);
          ...
          var d = function () {
            d.options.logging &&
              ...
              Function.prototype.bind
                ...
                .apply(
                  window.console,
                  [Date.now() - d.options.start + 'ms', 'html2canvas:'].concat(
                    [].slice.call(arguments, 0)
                  )
                );
          };
          (d.options = { logging: !1 }), (b.exports = d);
        },
        {},
      ],
      14: [
        function (a, b, c) {
          ...
          (d.prototype.cloneTo = function (a) {
            ...
            (d.prototype.prefixedCss = function (a) {
              ...
              return (
                void 0 === c &&
                  b.some(function (b) {
                    return (
                      (c = this.css(b + a.substr(0, 1).toUpperCase() + a.substr(1))), void 0 !== c
                    );
                  }, this),
                void 0 === c ? null : c
              );
            ...
            (d.prototype.parseBackgroundImages = function () {
              return (
                this.backgroundImages || (this.backgroundImages = n(this.css('backgroundImage')))
              );
            }),
            (d.prototype.cssList = function (a, b) {
              ...
              return (
                (c = c[b || 0] || c[0] || 'auto'),
                (c = c.trim().split(' ')),
                1 === c.length && (c = [c[0], h(c[0]) ? 'auto' : c[0]]),
                c
              );
            }),
            (d.prototype.parseBackgroundSize = function (a, b, c) {
              var d,
                e,
                f = this.cssList('backgroundSize', c);
              if (h(f[0])) d = (a.width * parseFloat(f[0])) / 100;
                ...
                if (/contain|cover/.test(f[0])) {
                  ...
                  return (g < i) ^ ('contain' === f[0])
                    ? { width: a.height * i, height: a.height }
                    : { width: a.width, height: a.width / i };
                }
                d = parseInt(f[0], 10);
              }
              return (
                (e =
                  'auto' === f[0] && 'auto' === f[1]
                    ...
                    ? (d / b.width) * b.height
                    : h(f[1])
                    ? (a.height * parseFloat(f[1])) / 100
                    : parseInt(f[1], 10)),
                'auto' === f[0] && (d = (e / b.height) * b.width),
                { width: d, height: e }
              );
            }),
            (d.prototype.parseBackgroundPosition = function (a, b, c, d) {
              var e,
                f,
                g = this.cssList('backgroundPosition', c);
              return (
                (e = h(g[0])
                  ? (a.width - (d || b).width) * (parseFloat(g[0]) / 100)
                  : parseInt(g[0], 10)),
                (f =
                  'auto' === g[1]
                    ? (e / b.width) * b.height
                    : h(g[1])
                    ? ((a.height - (d || b).height) * parseFloat(g[1])) / 100
                    : parseInt(g[1], 10)),
                'auto' === g[0] && (e = (f / b.height) * b.width),
                { left: e, top: f }
              );
            }),
            ...
            (d.prototype.parseTransform = function () {
              if (!this.transformData)
                if (this.hasTransform()) {
                  ...
                  (b[0] += a.left),
                    (b[1] += a.top),
                    (this.transformData = { origin: b, matrix: this.parseTransformMatrix() });
            ...
            (d.prototype.inverseTransform = function () {
              ...
              return { origin: a.origin, matrix: g(a.matrix) };
            }),
            (d.prototype.parseBounds = function () {
              return (
                this.bounds || (this.bounds = this.hasTransform() ? o(this.node) : m(this.node))
              );
            }),
            ...
            (d.prototype.getValue = function () {
              ...
              return (
                'SELECT' === this.node.tagName
                  ? (a = e(this.node))
                  : 'password' === this.node.type && (a = Array(a.length + 1).join('•')),
        ...
        function (a, b, c) {
          function d(a, b, c, d, e) {
            O('Starting NodeParser'),
              ...
              (this.support = c),
              (this.renderQueue = []),
              (this.stack = new V(!0, 1, a.ownerDocument, null));
            var f = new Q(a, null);
            if (
              (e.background && b.rectangle(0, 0, b.width, b.height, new U(e.background)),
              a === a.ownerDocument.documentElement)
            ) {
              var g = new Q(
                f.color('backgroundColor').isTransparent()
            ...
            (f.visibile = f.isElementVisible()),
              ...
              (this.images = d.fetch(this.nodes.filter(B))),
              (this.ready = this.images.ready.then(
                X(function () {
                  return (
                    O('Images loaded, starting parsing'),
                      ...
                      X(function (a) {
                        e.async
                          ? 'function' == typeof e.async
                            ...
                            ? ((this.renderIndex = 0), this.asyncRenderer(this.renderQueue, a))
                            : a()
                          : (this.renderQueue.forEach(this.paint, this), a());
                      }, this)
                    )
                  );
                }, this)
          ...
          function i(a, b, c, d) {
            var e = 4 * ((Math.sqrt(2) - 1) / 3),
              ...
              i = b + d;
            return {
              topLeft: k({ x: a, y: i }, { x: a, y: i - g }, { x: h - f, y: b }, { x: h, y: b }),
              topRight: k({ x: a, y: b }, { x: a + f, y: b }, { x: h, y: i - g }, { x: h, y: i }),
              bottomRight: k(
                { x: h, y: b },
                { x: h, y: b + g },
                { x: a + f, y: i },
              ...
              bottomLeft: k({ x: h, y: i }, { x: h - f, y: i }, { x: a, y: b + g }, { x: a, y: b }),
            };
          }
          function j(a, b, c) {
            var d = a.left,
              ...
              t = g - p;
            return {
              topLeftOuter: i(d, e, h, j).topLeft.subdivide(0.5),
              topLeftInner: i(
                d + c[3].width,
                e + c[0].width,
                Math.max(0, h - c[3].width),
                Math.max(0, j - c[0].width)
              ).topLeft.subdivide(0.5),
              topRightOuter: i(d + q, e, k, l).topRight.subdivide(0.5),
              topRightInner: i(
                d + Math.min(q, f + c[3].width),
                e + c[0].width,
                q > f + c[3].width ? 0 : k - c[3].width,
                l - c[0].width
              ).topRight.subdivide(0.5),
              bottomRightOuter: i(d + s, e + r, m, n).bottomRight.subdivide(0.5),
              bottomRightInner: i(
                d + Math.min(s, f - c[3].width),
                e + Math.min(r, g + c[0].width),
                Math.max(0, m - c[1].width),
                n - c[2].width
              ).bottomRight.subdivide(0.5),
              bottomLeftOuter: i(d, e + t, o, p).bottomLeft.subdivide(0.5),
              bottomLeftInner: i(
                d + c[3].width,
                e + t,
                Math.max(0, o - c[3].width),
                p - c[2].width
          ...
          function l(a, b, c, d, e, f, g) {
            ...
            return (
              b[0] > 0 || b[1] > 0
                ? (h.push(['line', d[1].start.x, d[1].start.y]), d[1].curveTo(h))
                : h.push(['line', a.c1[0], a.c1[1]]),
              c[0] > 0 || c[1] > 0
                ? (h.push(['line', f[0].start.x, f[0].start.y]),
                  f[0].curveTo(h),
                  h.push(['line', g[0].end.x, g[0].end.y]),
                  g[0].curveToReversed(h))
                : (h.push(['line', a.c2[0], a.c2[1]]), h.push(['line', a.c3[0], a.c3[1]])),
              b[0] > 0 || b[1] > 0
                ? (h.push(['line', e[1].end.x, e[1].end.y]), e[1].curveToReversed(h))
                : h.push(['line', a.c4[0], a.c4[1]]),
              h
            );
          }
          function m(a, b, c, d, e, f, g) {
            b[0] > 0 || b[1] > 0
              ? (a.push(['line', d[0].start.x, d[0].start.y]), d[0].curveTo(a), d[1].curveTo(a))
              : a.push(['line', f, g]),
          ...
          function E(a) {
            return function (b, c) {
              return (
                b.cssInt('zIndex') +
                a.indexOf(b) / a.length -
                (c.cssInt('zIndex') + a.indexOf(c) / a.length)
              );
            };
          }
          function F(a) {
          ...
          function I(a) {
            return (
              ...
              ['SCRIPT', 'HEAD', 'TITLE', 'OBJECT', 'BR', 'OPTION'].indexOf(a.node.nodeName) === -1
            );
          }
          function J(a) {
          ...
          function L(a) {
            for (var b, c = [], d = 0, e = !1; a.length; )
              M(a[d]) === e
                ? ((b = a.splice(0, d)), b.length && c.push(P.ucs2.encode(b)), (e = !e), (d = 0))
                : d++,
                d >= a.length && ((b = a.splice(0, d)), b.length && c.push(P.ucs2.encode(b)));
            return c;
          }
          function M(a) {
          ...
          (d.prototype.calculateOverflowClips = function () {
            this.nodes.forEach(function (a) {
              if (B(a)) {
                ...
                var b = 'hidden' === a.css('overflow') ? [a.borders.clip] : [],
                  c = a.parseClip();
                c &&
                  ['absolute', 'fixed'].indexOf(a.css('position')) !== -1 &&
                  b.push([
                    [
                      'rect',
                      a.bounds.left + c.left,
                      a.bounds.top + c.top,
                      c.right - c.left,
                      c.bottom - c.top,
                    ],
                  ]),
                  (a.clip = e(a) ? a.parent.clip.concat(b) : b),
                  (a.backgroundClip =
            ...
            (d.prototype.createPseudoHideStyles = function (a) {
              this.createStyles(
                a,
                '.' +
                  S.prototype.PSEUDO_HIDE_ELEMENT_CLASS_BEFORE +
                  ':before { content: "" !important; display: none !important; }.' +
                  S.prototype.PSEUDO_HIDE_ELEMENT_CLASS_AFTER +
            ...
            (d.prototype.getPseudoElement = function (a, b) {
              ...
              for (
                var d = K(c.content),
                  e = 'url' === d.substr(0, 3),
                  g = document.createElement(e ? 'img' : 'html2canvaspseudoelement'),
                  h = new S(g, a, b),
                  i = c.length - 1;
                i >= 0;
                i--
              ...
              if (
                ...
                return (g.src = Z(d)[0].args[0]), [h];
              var k = document.createTextNode(d);
              return g.appendChild(k), [h, new R(k, h)];
            }),
            (d.prototype.getChildren = function (a) {
              return J(
                [].filter.call(a.node.childNodes, v).map(function (b) {
                  var c = [b.nodeType === Node.TEXT_NODE ? new R(b, a) : new Q(b, a)].filter(I);
                  return b.nodeType === Node.ELEMENT_NODE && c.length && 'TEXTAREA' !== b.tagName
                    ? c[0].isElementVisible()
                      ? c.concat(this.getChildren(c[0]))
                      : []
                    : c;
                }, this)
              );
            ...
            (d.prototype.createStackingContexts = function () {
              this.nodes.forEach(function (a) {
                B(a) &&
                (this.isRootElement(a) ||
                  F(a) ||
                  w(a) ||
                  this.isBodyWithTransparentRoot(a) ||
                  a.hasTransform())
                  ? this.newStackingContext(a, !0)
                  : B(a) && ((x(a) && p(a)) || z(a) || y(a))
                  ? this.newStackingContext(a, !1)
                  : a.assignStack(a.parent.stack);
              }, this);
            }),
            (d.prototype.isBodyWithTransparentRoot = function (a) {
              return (
                'BODY' === a.node.nodeName && a.parent.color('backgroundColor').isTransparent()
              );
            }),
            ...
            (d.prototype.parseTextBounds = function (a) {
              return function (b, c, d) {
                if (
                  ...
                  (this.support.rangeBounds && !a.parent.hasTransform()) ||
            ...
            (d.prototype.paint = function (a) {
              try {
                a instanceof g
                  ...
                  : D(a)
                  ? (C(a.parent) && a.parent.appendToDOM(),
                    this.paintText(a),
                    C(a.parent) && a.parent.cleanDOM())
                  : this.paintNode(a);
              } catch (b) {
                  ...
                  function () {
                    switch (a.node.nodeName) {
                      ...
                      case 'IFRAME':
                        ...
                        c
                          ? this.renderer.renderImage(a, b, a.borders, c)
                          : O('Error loading <' + a.node.nodeName + '>', a.node);
                        break;
                      case 'IMG':
                        var d = this.images.get(a.node.src);
                        d
                          ? this.renderer.renderImage(a, b, a.borders, d)
                          : O('Error loading <img>', a.node.src);
                        break;
                      case 'CANVAS':
            ...
            (d.prototype.paintCheckbox = function (a) {
              var b = a.parseBounds(),
                ...
                g = [1, 1, 1, 1].map(function (a) {
                  return { color: new U('#A5A5A5'), width: a };
                }),
                i = j(d, f, g);
              this.renderer.clip(
                a.backgroundClip,
                function () {
                  this.renderer.rectangle(
                    ...
                    this.renderer.renderBorders(h(g, d, i, f)),
                    a.node.checked &&
                      (this.renderer.font(
                        new U('#424242'),
                        'normal',
                  ...
                  this.renderer.circleStroke(
                    ...
                    a.node.checked &&
                      this.renderer.circle(
                        Math.ceil(b.left + c / 4) + 1,
                        Math.ceil(b.top + c / 4) + 1,
                        Math.floor(c / 2),
                        new U('#424242')
                      );
                },
            ...
            (d.prototype.paintFormValue = function (a) {
              ...
              if (b.length > 0) {
                ...
                (d.style.position = 'fixed'),
                  ...
                  this.paintText(new R(d.firstChild, a)),
            ...
            (d.prototype.paintText = function (a) {
              ...
              this.renderer.font(
                a.parent.color('color'),
                a.parent.css('fontStyle'),
                a.parent.css('fontVariant'),
                e,
                f,
                g
              ),
                h.length
                  ? this.renderer.fontShadow(h[0].color, h[0].offsetX, h[0].offsetY, h[0].blur)
                ...
                this.renderer.clip(
                  ...
                  function () {
                    d.map(this.parseTextBounds(a), this).forEach(function (b, c) {
                      b &&
                        (this.renderer.text(d[c], b.left, b.bottom),
            ...
            (d.prototype.renderTextDecoration = function (a, b, c) {
              switch (a.css('textDecoration').split(' ')[0]) {
                case 'underline':
                  this.renderer.rectangle(
                    b.left,
                    Math.round(b.top + c.baseline + c.lineWidth),
                    b.width,
                    1,
                    a.color('color')
                  );
                ...
                case 'line-through':
                  this.renderer.rectangle(
                    b.left,
                    Math.ceil(b.top + c.middle + c.lineWidth),
                    b.width,
                    1,
                    a.color('color')
                  );
          ...
          (d.prototype.parseBorders = function (a) {
            var b = a.parseBounds(),
              ...
              e = j(b, c, d);
            return { clip: this.parseBackgroundClip(a, e, d, c, b), borders: h(d, b, e, c) };
          }),
            (d.prototype.parseBackgroundClip = function (a, b, c, d, e) {
              ...
              switch (f) {
                ...
                case 'padding-box':
                  ...
                  break;
                default:
                  m(g, d[0], d[1], b.topLeftOuter, b.topRightOuter, e.left, e.top),
                    m(g, d[1], d[2], b.topRightOuter, b.bottomRightOuter, e.left + e.width, e.top),
                    m(
                      g,
                      d[2],
                      d[3],
                    ...
                    m(g, d[3], d[0], b.bottomLeftOuter, b.topLeftOuter, e.left, e.top + e.height);
              }
              return g;
            }),
            (b.exports = d);
      ...
      16: [
        function (a, b, c) {
          ...
          function g(a) {
            return a
              ? ''
              : 'html2canvas_' + Date.now() + '_' + ++p + '_' + Math.round(1e5 * Math.random());
          }
          function h(a, b, c) {
            return (
              a +
              ...
              (c.length ? '&callback=html2canvas.proxy.' + c : '')
            );
          }
          function i(a) {
            return function (b) {
        ...
        function (a, b, c) {
          ...
          (d.prototype.renderImage = function (a, b, c, d) {
            ...
            (d.prototype.renderBackground = function (a, b, c) {
              b.height > 0 &&
                b.width > 0 &&
                (this.renderBackgroundColor(a, b), this.renderBackgroundImage(a, b, c));
            }),
              ...
              d.reverse().forEach(function (d, f, g) {
                switch (d.method) {
                  case 'url':
                    ...
                    h
                      ? this.renderBackgroundRepeating(a, b, h, g.length - (f + 1), c)
                      : e('Error loading background-image', d.args[0]);
                    break;
                  case 'linear-gradient':
                  case 'gradient':
                    var i = this.images.get(d.value);
                    i
                      ? this.renderBackgroundGradient(i, b, c)
                      : e('Error loading background-image', d.args[0]);
                    break;
                  case 'none':
                    break;
        ...
        function (a, b, c) {
              ...
              this.options.canvas ||
                ...
                this.options.scale
                  ? ((this.canvas.style.width = a + 'px'),
                    ...
                    (this.canvas.width = Math.floor(a * this.options.scale)),
                    (this.canvas.height = Math.floor(b * this.options.scale)),
                    this.ctx.scale(this.options.scale, this.options.scale))
                  : ((this.canvas.width = a), (this.canvas.height = b))),
              (this.taintCtx = this.document.createElement('canvas').getContext('2d')),
              (this.ctx.textBaseline = 'bottom'),
              (this.variables = {}),
              h('Initialized CanvasRenderer with size', a, 'x', b);
          }
          function e(a) {
            return a.length > 0;
          }
          ...
          (d.prototype = Object.create(f.prototype)),
            ...
            (d.prototype.drawImage = function (a, b, c, d, e, f, g, h, i) {
              (this.taints(a) && !this.options.allowTaint) ||
                this.ctx.drawImage(a.image, b, c, d, e, f, g, h, i);
            }),
            (d.prototype.clip = function (a, b, c, d) {
              this.ctx.save(),
                d && d.hasTransform()
                  ? (this.setTransform(d.inverseTransform()),
                    a.filter(e).forEach(function (a) {
                      this.shape(a).clip();
                    }, this),
                    this.setTransform(d.parseTransform()))
                  : a.filter(e).forEach(function (a) {
                      this.shape(a).clip();
                    }, this),
                b.call(c),
            ...
            (d.prototype.shape = function (a) {
              return (
                ...
                a.forEach(function (a, b) {
                  'rect' === a[0]
                    ? this.ctx.rect.apply(this.ctx, a.slice(1))
                    : this.ctx[0 === b ? 'moveTo' : a[0] + 'To'].apply(this.ctx, a.slice(1));
                }, this),
                this.ctx.closePath(),
                this.ctx
              );
            ...
            (d.prototype.fontShadow = function (a, b, c, d) {
              this.setVariable('shadowColor', a.toString())
                .setVariable('shadowOffsetY', b)
                .setVariable('shadowOffsetX', c)
                .setVariable('shadowBlur', d);
            }),
            ...
            (d.prototype.renderBackgroundGradient = function (a, b) {
              if (a instanceof g) {
                var c = this.ctx.createLinearGradient(
                  b.left + b.width * a.x0,
                  b.top + b.height * a.y0,
                  b.left + b.width * a.x1,
                  b.top + b.height * a.y1
        ...
        function (a, b, c) {
          ...
          (d.prototype.hasFabric = function () {
            ...
            (d.prototype.inlineFormatting = function (a) {
              return /^data:image\/svg\+xml;base64,/.test(a)
                ? this.decode64(this.removeContentType(a))
                : this.removeContentType(a);
            }),
              ...
              return function (c, d) {
                ...
                (b.image = e.lowerCanvasEl),
                  e
                    .setWidth(d.width)
                    .setHeight(d.height)
                    .add(window.html2canvas.svg.fabric.util.groupSVGElements(c, d))
                    .renderAll(),
                  a(e.lowerCanvasEl);
              };
            }),
            ...
            this.promise = b
              ? new Promise(function (b, d) {
                  (c.image = new Image()),
                    ...
                    (c.image.onerror = d),
                    (c.image.src =
                      'data:image/svg+xml,' + new XMLSerializer().serializeToString(a)),
                    c.image.complete === !0 && b(c.image);
                })
        ...
        function (a, b, c) {
          (c.smallImage = function () {
            ...
            (c.offsetBounds = function (a) {
              var b = a.offsetParent ? c.offsetBounds(a.offsetParent) : { top: 0, left: 0 };
              return {
              ...
              var b,
                ...
                m = function () {
                  b &&
                    ...
                    '-' === b.substr(0, 1) &&
                      (e = b.indexOf('-', 1) + 1) > 0 &&
                      ((d = b.substr(0, e)), (b = b.substr(e))),
                    j.push({ prefix: d, method: b.toLowerCase(), value: f, args: h, image: null })),
                    (h = []),
                    (b = d = c = f = '');
                };
              return (
